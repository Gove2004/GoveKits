...
namespace GoveKits.Localization
{
    public class LanguageManager
    {
        ...
        public static void Initialize()
        {
            ...
            _isInitialized = true;
            LogManager.Log("LanguageManager", $"初始化完成. 当前语言: {_setting.LanguageId}");
        }
        ...
        {
            if ((LanguageCode)_setting.LanguageId == code && _isInitialized) return;

            _setting.LanguageId = (int)code;
        ...
        public static TMP_FontAsset GetCurrentFont()
        {
            ...
            return _config.GetFont((LanguageCode)_setting.LanguageId);
        }
        ...
        private static void RefreshCache()
        {
            ...
            string langKey = ((LanguageCode)_setting.LanguageId).ToString();
        ...
        {
            if (SaveManager.LoadData(_setting, SavePath))
            {
                LogManager.LogGreen("LanguageManager", "Settings Loaded.");
            }
        }
    }
}