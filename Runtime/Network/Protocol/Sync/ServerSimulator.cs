...
namespace GoveKits.Runtime.Network
{
    internal class StateSimulator
    {
        ...
        // 收集客户端指令
        private readonly Dictionary<int, PlayerInputPackage> _clientInputs = new();
        // 缓存服务端下发的世界实体状态
        private readonly Dictionary<int, EntityState> _entityStates = new();

        public Action<List<PlayerInputPackage>> OnServerLogicTick;

        public void CollectInput(PlayerInputPackage input)
        {
