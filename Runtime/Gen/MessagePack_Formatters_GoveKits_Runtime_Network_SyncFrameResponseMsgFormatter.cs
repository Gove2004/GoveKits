...
namespace MessagePack.Formatters.GoveKits.Runtime.Network
{
    public sealed class SyncFrameResponseMsgFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::GoveKits.Runtime.Network.SyncFrameResponseMsg>
    {
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::GoveKits.Runtime.Network.SyncFrameResponseMsg value, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::GoveKits.Runtime.Network.FramePackage[]>(formatterResolver).Serialize(ref writer, value.HistoryFrames, options);
        }
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        ____result.HistoryFrames = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::GoveKits.Runtime.Network.FramePackage[]>(formatterResolver).Deserialize(ref reader, options);
                        break;
                    default:
                        reader.Skip();
                        break;
